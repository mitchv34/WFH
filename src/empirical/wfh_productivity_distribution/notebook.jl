...
# ╔═╡ b230672c-3263-44f7-82c8-2f1383526a4b
begin
	using CSV, DataFrames, Downloads
	using DataFrames, Statistics, StatsBase
	using FixedEffectModels, RegressionTables, DataFrames, KernelDensity
	using CairoMakie, LaTeXStrings, PyCall
	include("wfh_productivity_distribution.jl")
end

# ╔═╡ 5ea6e4c0-ef0b-11ef-3f05-f7009ecc3d5f
begin
	# Load data
	paths = define_paths();
	wfh_share_estimation, bls = DataLoader.load_datasets(paths);
...
# ╔═╡ d6c94b4b-80cb-4f2b-90fb-a23b4bb109f6
begin
	# Process data
	wfh_rates_3d = DataProcessor.process_wfh_rates(wfh_rates);
	telework_scores = DataProcessor.calculate_telework_scores(bls_ind_3d, wfh_share_estimation, onet_soc_xwalk);
	regression_data = DataProcessor.prepare_regression_data(productivity_3d, telework_scores, wfh_rates_3d);
end

# ╔═╡ 27e15c39-c951-4adc-8802-6be1d0a6a737
# Fit models
begin
	models_unweighted, models_weighted = Models.fit_regression_models(regression_data);
	regtable(
		models_unweighted.base,
		models_unweighted.year_fe,
		models_unweighted.sector_fe,
		models_unweighted.base,
		models_unweighted.year_fe,
		models_unweighted.sector_fe,
		render = HtmlTable()
...
# ╔═╡ 8e7ed464-348d-4c1b-873d-58d1c787435f
begin
	# Get psi distribution
	data_density_3d = Models.create_psi_distribution(telework_scores, bds_3d, models_unweighted.base);
	psi_distribution = Models.fit_kde_psi(
				data_density_3d[!, :ψ], data_density_3d[!, :JOB_CREATION_BIRTHS];
				num_grid_points=50, 
				bandwidth=1, 
				boundary=false,
				engine="python"
...
# ╔═╡ eb7a1ba6-9520-4717-a166-cf71c87ae6d7
analysis_plots[1]

# ╔═╡ 1c4aca79-657d-4ebe-84eb-51d8c79c0327
analysis_plots[2]

# ╔═╡ 62e419d1-f02c-4cac-a19c-5b094af24e60
...
manifest_format = "2.0"
project_hash = "0ea87a57a9129374286fc3762a413be48331240b"
...
git-tree-sha1 = "871b14215f88cbc4590b74e433a2df15c9a6b6c4"
...
git-tree-sha1 = "ff6d3659bff2b6309e0628e4bdf1783aaf891c09"
